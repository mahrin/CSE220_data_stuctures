public class GraphWeightedAdjacencyList {
    private int numVertices;
    private WEdge[] adjList;

    public GraphWeightedAdjacencyList(int numVertices) {
    ...
    public static void main(String[] args) {
        ...
        GraphWeightedAdjacencyList graph = new GraphWeightedAdjacencyList(numVertices);
